...
List<Customer> customers = new()
{
    ...
    new Customer()
    {
        Id = 2,
        Name = "Paul",
        Address = "45 Paulie Dr."
    },
    new Customer()
    {
        Id = 3,
        Name = "Nick",
        Address = "78 Claus Boulevard"
    }
};
...
List<ServiceTickets> serviceTickets = new()
{
    new ServiceTickets()
    {
        ...
        CustomerID = 1,
        EmployeeID = 1,
        Description = "Car got broken into",
        isEmergency = true,
        DateCompleted = new DateTime(2024, 1, 6)
    },
    new ServiceTickets()
    {
        Id = 2,
        CustomerID = 2,
        EmployeeID = 2,
        Description = "Couldn't punch out",
        isEmergency = false,
    ...
    new ServiceTickets()
    {
        ...
        CustomerID = 1,
        EmployeeID = 2,
        Description = "Need a new password",
        isEmergency = true,
        DateCompleted = new DateTime(2023, 9, 12)
    },
    ...
    new ServiceTickets()
    {
        ...
        isEmergency = true,
        DateCompleted = new DateTime(2023, 7, 12)
    }
};
